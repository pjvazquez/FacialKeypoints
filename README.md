...
```
git clone https://github.com/pjvazquez/FacialKeypoints.git
cd FacialKeypoints
```
...
2. Create (and activate) a new environment with Python 3.5 and the `numpy` package.
	...
	```
	conda create --name computervision python=3.9 numpy
	source activate computervision
	```
	- __Windows__: 
	```
	conda create --name computervision python=3.9 numpy scipy
